...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="max-w-2xl w-full p-6 bg-white rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-blue-800 text-center">Form Surat Keterangan Mahasiswa Aktif</h1>
        ...
        <form method="POST" action="{{ route('surat.aktif.store') }}">
            ...
            <!-- Keperluan -->
            <div class="mb-6">
                <label class="block text-gray-700 font-medium mb-2">Keperluan Pengajuan</label>
                <input type="text" name="keperluan" class="w-full px-4 py-2 border rounded" placeholder="Contoh: Pengajuan beasiswa KIP">
            </div>
