...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="max-w-2xl w-full p-6 bg-white rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-blue-800 text-center">Surat Keterangan Lulus</h1>
        ...
        <form method="POST" action="{{ route('surat.aktif.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal" class="w-full px-4 py-2 border rounded bg-white" required>
            </div>
